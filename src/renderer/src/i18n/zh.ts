...
export const zh: typeof en = {
  ...
  'project.close': '关闭',
  'project.recordTooltip': '通过 CS2 录制选中的精彩时刻',
  ...
  'settings.detected': '已检测到 CS2 路径',
  'settings.notDetected': '未检测到 CS2，请先安装 CS2 或手动设置路径。',
  ...
  'settings.obsHost': '主机地址',
  'settings.obsPort': '端口',
  'settings.obsPassword': '密码',
  'settings.obsDescription': '配置 OBS Studio WebSocket 连接以进行自动录制。',
  'settings.testConnection': '测试连接',
  'settings.obsConnected': '已连接到 OBS {version}',
  'settings.obsConnectionFailed': '连接失败：{error}',

  // RecordingPage
  'recording.title': '录制',
  'recording.description': '使用 OBS WebSocket 录制精彩时刻。',
  'recording.subDescription': '需要安装 CS2。',
  'recording.preparing': '正在准备录制...',
  'recording.launchingCs2': '正在启动 CS2...',
  'recording.waitingLoad': '等待 CS2 加载...',
  'recording.recording': '录制中...',
  'recording.stopping': '正在停止录制...',
  'recording.cancel': '取消录制',
  'recording.cancelled': '录制已取消',
  'recording.complete': '录制完成',
  'recording.clipsRecorded': '已录制 {count} 个片段',
  'recording.recordAgain': '重新录制',
  'recording.recordingFailed': '录制失败',
  'recording.tryAgain': '重试',
  'recording.highlightOf': '精彩时刻 {current} / {total}',
  'recording.round': '回合',
  'recording.noHighlights': '未选择精彩时刻。请返回并选择要录制的精彩时刻。',
  'recording.backToProject': '返回项目',
